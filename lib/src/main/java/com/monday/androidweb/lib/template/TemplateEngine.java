...
//                logger.warning("Can't instance processor pool(use default) >>> " + poolClass);
    ...
    public String process(String templateFile, Object bindings) throws IOException, IllegalAccessException, IntrospectionException, InvocationTargetException {
        Processor processor = pool.pop();
        if (processor == null) {
            processor = new Processor(application);
        }
    ...
    public void process(String templateFile, Object bindings, Writer out)
